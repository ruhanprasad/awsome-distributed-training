# Adapted from https://github.com/HazyResearch/flash-attention/blob/main/flash_attn/losses/cross_entropy.py
# commit 85b51d61eea5ed85c93168262048005c1a9131c0, tag: v1.0.7
...
class SoftmaxCrossEntropyLossFn(torch.autograd.Function):
    ...
    # Rubik change: Added vocab_range argument
    @staticmethod
    def forward(
        ctx,
        logits,
        ...
        if world_size == 1:
            ...
            # Rubik change: Changed how vocab_start_index and vocab_end_index are calculated
