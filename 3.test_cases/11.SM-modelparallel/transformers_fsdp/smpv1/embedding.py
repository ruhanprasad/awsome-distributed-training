...
# First Party
from .core import cfg, logger, tp_rank, tp_size
from .utils import (
    allgather_for_tp,
...
class DistributedEmbedding(nn.Embedding):
    def __init__(
        self,
        num_embeddings,
        embedding_dim,
        ...
        if self.vocab_parallel:
            channels = [get_local_channels(num_embeddings, r) for r in range(tp_size())]
            self.embedding_dim = embedding_dim
            self.num_embeddings = channels[tp_rank()]
        ...
        self.fp16_params = cfg._fp16_param_init
